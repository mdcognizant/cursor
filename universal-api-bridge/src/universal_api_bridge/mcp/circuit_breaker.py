...
# Simple counter for circuit breaker state changes
circuit_breaker_state_changes = Counter()

# Simple counter for circuit breaker requests
circuit_breaker_requests = Counter()

# Simple dict for circuit breaker failure rate
circuit_breaker_failure_rate = {}

# Simple list for circuit breaker response times
...
class AdvancedCircuitBreaker:
    ...
    async def call(self, func: Callable, *args, timeout: Optional[float] = None, **kwargs) -> Any:
        ...
        try:
            ...
            circuit_breaker_response_time.append(call_duration)
